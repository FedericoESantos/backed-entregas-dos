const comprar = async (pid) => {
    ...
    let inputCarrito = document.getElementById("carrito"); // aca capturamos el id del carrito
    let cid = inputCarrito.value; // aca capturamos el id del carrito dentro de la variable cid  
